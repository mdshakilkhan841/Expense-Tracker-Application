    ...
    return (
        <section className="text-black body-font flex items-center justify-center md:mt-32 mt-20">
            <div className="w-full container mx-auto py-3 px-5 max-w-3xl space-y-2">
                ...
                {/* <!-- The First FAQ --> */}
                <details className="bg-[rgba(75,192,192,0.2)] open:bg-[rgba(54,162,235,0.2)] duration-300 border border-[rgb(75,192,192)] open:border-[rgb(54,162,235)]">
                    <summary className="relative bg-inherit pl-5 pr-14 py-2 text-lg cursor-pointer list-none flex justify-between font-semibold">
                        ...
                        <span className="text-green-700 font-bold">{`250`} Tk</span>
                    </summary>
                                ...
                                <div className="inline-block min-w-full">
                                    <div className="overflow-hidden">
                                        ...
                                        <table className="min-w-full text-left text-sm font-light table-auto ">
                                            ...
                                            <tbody>
                                                <tr className="odd:bg-neutral-100 even:bg-neutral-200 font-medium sm:text-center">
